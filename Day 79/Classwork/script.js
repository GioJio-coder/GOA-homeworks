...
position += 2; 
for (let i = 0; i < boxes.length; i++) {
    boxes[i].style.left = position + "px";
}
if (position < 300) { 
...
moveCount++;
  box.style.left = (moveCount * 10) + "px";
